...
widget:connect_signal("property::value", function()
	awful.spawn('xbacklight -set ' .. math.max(widget.value, 5))
end)
...
awful.screen.connect_for_each_screen(function(s)
    ...
    local layouts = { l.tile.right, l.fair, l.floating, l.fair, l.max,
...
globalkeys = gears.table.join(
    ...
    {description = 'xrander monitors', group="Monitor"}),
...
-- VS Code
    ...
    awful.util.spawn('code') end,
              {description = "run Visual Studio Code", group = "Apps"}),
-- Rofi Window	
...
-- Nemo	
    ...
    awful.util.spawn('nemo') end,
              {description = "run nemo file manager", group = "Apps"}),
-- Power Off	
    awful.key({ modkey, 'Shift' },            "s",     function ()   
    awful.util.spawn('poweroff') end,
...
awful.rules.rules = {
    ...
    -- { rule = { class = "Firefox" },
    --   properties = { screen = 1, tag = "2" } },iiII
}
-- }}}
